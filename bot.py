    ...
    async def start(self):
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Berhenti. Gabung Group https://t.me/indonesia untuk Bantuan"
            )
            sys.exit()
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/bling2indonesia untuk Bantuan"
                )
                sys.exit()
        ...
        self.LOGGER(__name__).info(
            f"[🔥 BERHASIL DIAKTIFKAN! 🔥]\n\nBOT Dibuat oleh @{OWNER}\nJika @{OWNER} Membutuhkan Bantuan, Silahkan Tanyakan di Grup https://t.me/bling2indonesia"
        )
